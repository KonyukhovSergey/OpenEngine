...
JNIEXPORT jint JNICALL Java_js_jni_code_NativeCalls_ssDraw20(JNIEnv *env, jclass, jobject buffer)
{
	return ss.draw20((float*) env->GetDirectBufferAddress(buffer));
}
...
JNIEXPORT void JNICALL Java_js_jni_code_NativeCalls_noise(JNIEnv *env, jclass, jobject buffer, jint size, jfloat freq,
		jfloat offset, jfloat time)
{
